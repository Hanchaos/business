 ...
 */
#ifndef PICSERVER_INCLUDE_PICSERVER_SERVER_HTTPS_H_
#define PICSERVER_INCLUDE_PICSERVER_SERVER_HTTPS_H_
  ...
  void accept() override {
    auto session =
        std::make_shared<Session>(config.max_request_streambuf_size,
                                  create_connection(*io_service, context));

    acceptor->async_accept(session->connection->socket->lowest_layer(),
...
#endif  // PICSERVER_INCLUDE_PICSERVER_SERVER_HTTPS_H_
