...
#ifndef PICSERVER_INCLUDE_PICSERVER_CRYPTO_H_
#define PICSERVER_INCLUDE_PICSERVER_CRYPTO_H_
...
inline double round(double x) noexcept {  // Custom definition of round() for
                                          // positive numbers
  return floor(x + 0.5);
}
#endif
...
#endif  // PICSERVER_INCLUDE_PICSERVER_CRYPTO_H_
