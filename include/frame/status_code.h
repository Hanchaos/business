...
#ifndef PICSERVER_INCLUDE_PICSERVER_STATUS_CODE_H_
#define PICSERVER_INCLUDE_PICSERVER_STATUS_CODE_H_
...
const static std::vector<std::pair<StatusCode, std::string>> &
...
#endif  // PICSERVER_INCLUDE_PICSERVER_STATUS_CODE_H_
